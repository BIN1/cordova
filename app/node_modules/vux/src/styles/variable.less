...
@actionsheet-label-warn-color: #b4282d;
...
* tabbar
*/
@tabbar-text-active-color: #8fc31f;
...
@button-warn-bg-color: #b4282d;
@button-warn-active-color: #b4282d;
...
@button-primary-bg-color: #8fc31f;
...
@toast-top: 180px;
@toast-position-top-offset: 100px;
...
* search
*/
@search-cancel-font-color: #8fc31f;
