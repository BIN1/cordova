<template>
  ...
  <div class="pswp vux-previewer" tabindex="-1" role="dialog" aria-hidden="true">
      ...
      <div class="pswp__scroll-wrap">
        ...
        <div class="pswp__container" style="background:#fff;">
        ...
        <div class="pswp__ui pswp__ui--hidden">
          <div class="pswp__top-bar" style="background:#fff;">
            <!--  Controls are self-explanatory. Order can be changed. -->
            <div class="pswp__counter"  style="color:#333!important;"></div>
            <!-- <button class="pswp__button pswp__button--close" style="color:#666;"></button> -->
